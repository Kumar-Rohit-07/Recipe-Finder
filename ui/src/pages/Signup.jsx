    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-black text-white">
      ...
      <div className="backdrop-blur-lg bg-white/10 p-8 rounded-2xl shadow-xl border border-white/20 w-96 mt-20">
        ...
        <form className="flex flex-col space-y-4">
          <input type="text" placeholder="Full Name" className="px-4 py-2 rounded-lg bg-white/20 text-white border border-white/30" />
          ...
          <button className="px-4 py-2 rounded-lg bg-gradient-to-r from-blue-400 to-purple-500 text-white font-semibold">Signup</button>
        </form>
      </div>
    </div>
  );
